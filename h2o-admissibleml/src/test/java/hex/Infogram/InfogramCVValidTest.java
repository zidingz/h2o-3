...
public class InfogramCVValidTest  extends TestUtil {
    ...
    public void testCVValidationCore() {
        try {
            ...
            Frame relCmiTrain = DKV.getGet(infogramModel._output._relCmiKey);
            Scope.track(relCmiTrain);
            Frame relCmiTrainV = DKV.getGet(infogramModelV._output._relCmiKey);
            Scope.track(relCmiTrainV);
            Frame relCmiTrainVCV = DKV.getGet(infogramModelVCV._output._relCmiKey);
            Scope.track(relCmiTrainVCV);
            Frame relCmiTrainCV = DKV.getGet(infogramModelCV._output._relCmiKey);
            ...
            Frame relCmiValidV = DKV.getGet(infogramModelV._output._relCmiKey_valid);
            Scope.track(relCmiValidV);
            Frame relCmiValidVCV = DKV.getGet(infogramModelVCV._output._relCmiKey_valid);
            ...
            Frame relCmiCV = DKV.getGet(infogramModelCV._output._relCmiKey_xval);
            Scope.track(relCmiCV);
            Frame relCmiVCV = DKV.getGet(infogramModelVCV._output._relCmiKey_xval);
    ...
    public void testValidationCoreDuplicate() {
        try {
            ...
            Frame relCmiFrame = DKV.getGet(infogramModel._output._relCmiKey);
            Scope.track(relCmiFrame);
            Frame relCmiFrame2 = DKV.getGet(infogramModel2._output._relCmiKey);
            ...
            InfogramModel infogramModelV = new Infogram(params).trainModel().get();
            Scope.track_generic(infogramModelV);
            Frame relCmiFrameV = DKV.getGet(infogramModelV._output._relCmiKey);
            ...
            Frame relCmiFrameV2 = DKV.getGet(infogramModelV2._output._relCmiKey);
    ...
    public void testCVCoreDuplicate() {
        try {
            ...
            Frame relCmiFrameTrain = DKV.getGet(infogramModel._output._relCmiKey);
            Scope.track(relCmiFrameTrain);
            Frame relCmiFrameTrain2 = DKV.getGet(infogramModel2._output._relCmiKey);
            Scope.track(relCmiFrameTrain2);
            TestUtil.assertFrameEquals(relCmiFrameTrain, relCmiFrameTrain2, 1e-6);

            Frame relCmiFrameCV = DKV.getGet(infogramModel._output._relCmiKey_xval);
            Scope.track(relCmiFrameCV);
            Frame relCmiFrameCV2 = DKV.getGet(infogramModel2._output._relCmiKey_xval);
    ...
    public static void assertCorrectCVCore(InfogramModel infogramModel) {
        ...
        Frame relCmiKeyCV = DKV.getGet(infogramModel._output._relCmiKey_xval);
    ...
    public void testValidationSafeDuplicate() {
        try {
            ...
            Frame relCmiTrain = DKV.getGet(infogramModel._output._relCmiKey);
            Scope.track(relCmiTrain);
            Frame relCmiTrain2 = DKV.getGet(infogramModel2._output._relCmiKey);
            ...
            Frame relCmiVTr = DKV.getGet(infogramModelV._output._relCmiKey);
            Scope.track(relCmiVTr);
            Frame relCmiV2Tr = DKV.getGet(infogramModelV2._output._relCmiKey);
            Scope.track(relCmiV2Tr);
            TestUtil.assertFrameEquals(relCmiV2Tr, relCmiVTr, 1e-6);
            
            Frame relCmiV = DKV.getGet(infogramModelV._output._relCmiKey_valid);
            Scope.track(relCmiV);
            Frame relCmiV2 = DKV.getGet(infogramModelV2._output._relCmiKey_valid);
    ...
    public void testCVSafeDuplicate() {
        try {
            ...
            Frame relCmiFrameValid = DKV.getGet(infogramModel._output._relCmiKey_xval);
            Scope.track(relCmiFrameValid);
            Frame relCmiFrameTrainValid2 = DKV.getGet(infogramModel2._output._relCmiKey_xval);
    ...
    public void assertCorrectRuns(InfogramModel modelWOValid, InfogramModel modelWValid) {
        ...
        Frame relCmiNoValid = DKV.getGet(modelWOValid._output._relCmiKey);
        Scope.track(relCmiNoValid);
        Frame relCmiValid = DKV.getGet(modelWValid._output._relCmiKey);
        ...
        Frame relCmi_valid = DKV.getGet(modelWValid._output._relCmiKey_valid);
