...
public class InfogramCVValidTest  extends TestUtil {
    ...
    public void testCVValidationCore() {
        try {
            ...
            Frame relCmiCV = DKV.getGet(infogramModelCV._output._relCmiKey_cv);
            Scope.track(relCmiCV);
            Frame relCmiVCV = DKV.getGet(infogramModelVCV._output._relCmiKey_cv);
    ...
    public void testCVCoreDuplicate() {
        try {
            ...
            Frame relCmiFrameCV = DKV.getGet(infogramModel._output._relCmiKey_cv);
            Scope.track(relCmiFrameCV);
            Frame relCmiFrameCV2 = DKV.getGet(infogramModel2._output._relCmiKey_cv);
    ...
    public static void assertCorrectCVCore(InfogramModel infogramModel) {
        ...
        Frame relCmiKeyCV = DKV.getGet(infogramModel._output._relCmiKey_cv);
    ...
    public void testCVSafeDuplicate() {
        try {
            ...
            Frame relCmiFrameValid = DKV.getGet(infogramModel._output._relCmiKey_cv);
            Scope.track(relCmiFrameValid);
            Frame relCmiFrameTrainValid2 = DKV.getGet(infogramModel2._output._relCmiKey_cv);
